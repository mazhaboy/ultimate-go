...
func main() {
	...
	// Capacity is the total numbe0r of elements from this pointer position that exist in the
	// backing array.

	// Syntactic sugar -> looks like array
	// It also have the same cost that we've seen in array.
	// One thing to go: there is no value in the bracket []string inside the make
